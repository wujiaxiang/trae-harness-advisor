...
| AP2 | 派发的 SubAgent 能加载**指定角色 Skill**（generator-role / evaluator-role） | Generator/Evaluator 子代理 | 子代理报告已加载并能引用该 Skill 行为准则 |
| AP3 | SubAgent 拥有**独立上下文**（隔离，看不到对方推理） | Evaluator 子代理 | 报告自己无法看到 Generator 的内部思考，只能读 gen.md 文件 |
